...
:class: note
All used EddyPro processing settings can be downloaded directly from the repository [here](https://github.com/holukas/dataset_ch-cha_flux_product/tree/main/dataset_ch-cha_flux_product/data/EddyPro_settings).
`````
